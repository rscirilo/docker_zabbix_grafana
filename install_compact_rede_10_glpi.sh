...
chmod -R 775 /srv/docker/glpi-files || true
...
services:
  ...
  glpi-db:
    ...
    environment:
      ...
      MYSQL_ROOT_PASSWORD: \${MYSQL_ROOT_PASSWORD}
    volumes:
      - /srv/docker/glpi-mysql:/var/lib/mysql
    networks:
      - monitoring
  ...
  glpi:
    ...
    environment:
      ...
      GLPI_DB_PASSWORD: \${GLPI_DB_PASSWORD}
    volumes:
      - /srv/docker/glpi-files:/var/lib/glpi
    networks:
      - monitoring
